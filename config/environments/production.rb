Web::Application.configure do
  ...
  config.action_mailer.default_url_options = { :host => 'www.ohheyworld.com' }
...
Web::Application.config.middleware.use ExceptionNotifier,
  :email_prefix => "OhHeyWorld ",
  :sender_address => %{"Support" <support@ohheyworld.com>},
