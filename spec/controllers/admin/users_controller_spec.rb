  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved admin_user as @admin_user" do
        ...
        post :create, {:admin_user => { "email" => "invalid value" }}, valid_session
        assigns(:admin_user).should be_a_new(Admin::User)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested admin_user" do
        ...
        Admin::User.any_instance.should_receive(:update_attributes).with({ "email" => "MyString" })
        put :update, {:id => user.to_param, :admin_user => { "email" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the admin_user as @admin_user" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Admin::User.any_instance.stub(:save).and_return(false)
        put :update, {:id => user.to_param, :admin_user => { "email" => "invalid value" }}, valid_session
        assigns(:admin_user).should eq(user)
      end
